...
import com.example.temenin_1.ui.theme.bgFemale
import com.example.temenin_1.ui.theme.bgMale

val cardfemale = listOf(
    Temenin(
...
fun SectionFemale(){
    Column (
        ...
        Row(
            modifier = Modifier
                .background(bgFemale, shape = RoundedCornerShape(4.dp))
                .padding(vertical = 8.dp, horizontal = 16.dp)
                .height(IntrinsicSize.Min),
            verticalAlignment = Alignment.CenterVertically
        ) {
            Icon(
                painter = painterResource(id = R.drawable.women_line),
...
@Composable
fun CardFemale(index: Int){
    val cardfemale  = cardfemale[index]
    ...
    Card(
        ...
        Row() {
            Image( modifier = Modifier
                .size(120.dp)
                .fillMaxSize(),
                painter = painterResource(id = cardfemale.image),
                contentDescription = cardfemale.name
            )
...
//                        LEVEL Penjual
                    Text(modifier = Modifier
                        ...
                        .padding(8.dp),
                        text = "Level ${cardfemale.level.toString()}",
                        color = Color.White,
...
//                        RATING Penjual
                    Text(modifier = Modifier
                        ...
                        .padding(8.dp),
                        text = "Rate ${cardfemale.rating.toString()}",
                        color = Female,
                        style = TextStyle(fontWeight = FontWeight.SemiBold, fontSize = 10.sp)
                    )
                }
